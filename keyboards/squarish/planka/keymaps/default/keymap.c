...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_4x12(    // Letters
        ...
        KC_LCTL,  KC_LGUI, KC_LALT, TO(1),      SQ_LOWER,       SQ_SPC_L,     SQ_SPC_R,     SQ_RAISE,     KC_LEFT,      KC_DOWN,    KC_UP,      KC_RGHT
    ),
    [1] = LAYOUT_ortho_4x12(    // Numbers and symbols
        ...
        _______,  _______, _______, TO(2),      _______,        KC_APP,       KC_APP,       _______,      KC_LEFT,      KC_DOWN,    KC_UP,      KC_RGHT
    ),
    [2] = LAYOUT_ortho_4x12(    // Function keys and NumPad
        ...
        KC_RCTL,  KC_RGUI, KC_RALT, TO(3),      MO(3),          _______,      _______,      KC_P0,        KC_PDOT,      KC_PENT,    KC_PPLS,    KC_EQL
    ),
