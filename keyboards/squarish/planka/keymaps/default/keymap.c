...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_ortho_4x12(    // Letters
        ...
        KC_LCTL,  TO(1),   KC_LGUI, KC_LALT,    SQ_LOWER,       SQ_SPC_L,     SQ_SPC_R,     SQ_RAISE,     KC_LEFT,      KC_DOWN,    KC_UP,      KC_RGHT
    ),
    [1] = LAYOUT_ortho_4x12(    // Numbers and symbols
        ...
        _______,  _______, _______, _______,    KC_DEL,         KC_DEL,       KC_DEL,       KC_DEL,       KC_HOME,      KC_PGDN,    KC_PGUP,    KC_END,
        _______,  TO(2),   _______, _______,    _______,        KC_APP,       KC_APP,       _______,      KC_LEFT,      KC_DOWN,    KC_UP,      KC_RGHT
    ),
    ...
    [3] = LAYOUT_ortho_4x12(    // RGB control, PrintScreen, Media keys
        UG_HUEU,  UG_SATU, UG_VALU, XXXXXXX,    XXXXXXX,        QK_BOOT,      LAG(KC_PSCR), A(KC_PSCR),   XXXXXXX,      XXXXXXX,    KC_PAUSE,   G(KC_PAUSE),
        UG_HUED,  UG_SATD, UG_VALD, XXXXXXX,    XXXXXXX,        XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,    XXXXXXX,    XXXXXXX,
        _______,  UG_TOGG, UG_TOGG, XXXXXXX,    XXXXXXX,        XXXXXXX,      XXXXXXX,      KC_MUTE,      KC_MRWD,      KC_MFFD,    KC_MSTP,    KC_MPLY,
        _______,  TO(0),   _______, _______,    TO(0),          TO(0),        XXXXXXX,      XXXXXXX,      KC_MPRV,      KC_VOLD,    KC_VOLU,    KC_MNXT
    )
};
